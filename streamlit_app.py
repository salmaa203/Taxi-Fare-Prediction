...
st.markdown('<div class="main-title">Taxi Fare Prediction</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Select your pickup and dropoff locations on the map and enter the trip details to estimate the taxi fare.</div>', unsafe_allow_html=True)
...
st.markdown('<div class="section-title">Trip Information</div>', unsafe_allow_html=True)
...
with col3:
    ...
    year = st.number_input("Year", min_value=2009, max_value=2030, value=2026, step=1)
...
st.markdown('<div class="section-title">Trip Conditions</div>', unsafe_allow_html=True)

col1, col2, col3 = st.columns(3)

with col1:
    car_condition_name = st.selectbox("Car Condition", ["Bad", "Excellent", "Good", "Very Good"])
    car_condition_map = {"Bad": 0, "Excellent": 1, "Good": 2, "Very Good": 3}
    car_condition = car_condition_map[car_condition_name]

with col2:
    weather_name = st.selectbox("Weather", ["Cloudy", "Rainy", "Stormy", "Sunny", "Windy"])
    weather_map = {"Cloudy": 0, "Rainy": 1, "Stormy": 2, "Sunny": 3, "Windy": 4}
    weather = weather_map[weather_name]

with col3:
    traffic_name = st.selectbox("Traffic Condition", ["Congested Traffic", "Dense Traffic", "Flow Traffic"])
    traffic_map = {"Congested Traffic": 0, "Dense Traffic": 1, "Flow Traffic": 2}
...
st.markdown('<div class="section-title">Select Route</div>', unsafe_allow_html=True)
st.write("Click once on the map to select Pickup, then click again to select Dropoff.")
...
st.markdown('<div class="footer">Machine Learning Deployment Project</div>', unsafe_allow_html=True)
